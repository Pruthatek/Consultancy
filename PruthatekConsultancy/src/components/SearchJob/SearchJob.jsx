    ...
    const filtered = jobList.filter((job) => {
      const matchesFormValues =
        ...
        (!formValues.companyName ||
          job.companyName
            .toLowerCase()
            .includes(formValues.companyName.toLowerCase())) &&
        (!formValues.jobType ||
          job.jobType.toLowerCase().includes(formValues.jobType.toLowerCase()));
    ...
    <>
            ...
            <div className="w-full absolute bottom-20   flex flex-col items-center">
              <div className="searchBar lg:w-[60%] md:w-[80%] w-[90%] flex md:h-[66px] h-[44px] items-center bg-white rounded-full ">
                <input
                  ...
                  className=" w-[70%] h-full rounded-full px-8 outline-none focus:outline md:placeholder:text-[20px] placeholder:text-[16px] placeholder:font-[400]  placeholder:text-[#B3B3B3]  "
                />
                <button
                  onClick={handleSubmit1}
                  className="w-[29.7%] md:h-[62px] h-[40px] relative bg-black rounded-full border 
      ...
      <div className="w-full flex justify-center my-14 ">
        <form
          ...
          className="lg:w-[75%] w-[90%] h-fit rounded-[30px] md:px-12 px-8 md:py-10 py-8 border border-[#B3B3B3] shadow-lg "
        >
          <div className="w-full flex md:flex-row flex-col gap-y-6 gap-x-6">
            <div className="flex flex-col md:w-[50%] w-full">
              <label className="font-semibold md:text-[20px] text-[18px] font-poppins text-black ">
                Job Location
              </label>
              <input
                name="location"
                ...
                className=" w-full h-[40px] placeholder:text-[14px] placeholder:font-normal placeholder:text-[#B3B3B3] px-4 mt-2  rounded-[5px] border border-[#B3B3B3] "
              />
            </div>
          ...
          <div className="w-full flex md:flex-row flex-col items-center gap-x-6 md:mt-12 mt-6">
            ...
            <div className=" md:w-[25%] w-full mt-6 md:mt-0 ">
              <p className="font-semibold md:text-[20px] text-[18px]  font-poppins text-black ">
                Job Type
              </p>
              <div className="flex gap-x-4">
                <div className="flex items-center mt-2">
                  <input
                    ...
                    value="Permanent"
                    onChange={handleFormChange}
                    className=" w-[20px]  h-[20px] accent-black rounded-full border border-[#B3B3B3] "
                  />
                  <label className="text-[1rem] font-normal ml-2 font-poppins text-black ">
                    Permanent
                  </label>
                </div>
                <div className="flex items-center mt-2">
            ...
            <div className="lg:flex hidden w-[25%]">
              <button
                className="w-full md:h-[57px] mt-3 h-[40px] relative bg-black rounded-[8px] border 
      ...
      <div className="JOBS lg:w-[80%] w-[90%] mx-auto">
        <p className="font-medium text-[30px] text-black font-poppins ">
          {filteredJobs.length}{" "}
          {filteredJobs.length > 1 ? "Jobs Available" : "Job Available"}{" "}
        </p>
        ...
        <div className="flex flex-col gap-y-5 my-6">
          {filteredJobs.map((job, index) => {
            return (
              <div
                onClick={() => changeContent(job.id)}
                key={job.id}
                className="w-full cursor-pointer h-fit py-6 border  border-[#B3B3B3] px-6 flex flex-col  rounded-[20px] shadow-md "
              >
                <div className="flex md:flex-row flex-col gap-x-4">
                  ...
                  <div className="flex flex-col gap-y-2 flex-grow">
                    <h2 className="font-medium text-[24px] text-black font-poppins ">
                      {job.companyName}
                    </h2>
                    <h2 className="font-medium text-[24px] text-black font-poppins ">
                      {job.jobTitle}
                    </h2>
                    <p className="font-medium text-[18px] text-black font-poppins ">
                      {" "}
                      <b className="font-semibold text-[18px] text-black font-poppins ">
                        Job type:
                      </b>
                      &nbsp; {job.jobType}
                    </p>
                    <div className="flex gap-x-2">
                      ...
                      <p className="font-normal text-[18px] text-black font-poppins ">
                        {job.timeline}
                      </p>
                    </div>
                    <div className="flex gap-x-2">
                ...
                {toggle && expandContent === job.id && (
                  <>
                    <p className="font-semibold mt-4 mb-2 text-[20px] text-black font-poppins ">
                      Task and Responsibilities
                    </p>
                    {job.task.map((list, index) => {
                      return (
                        <li className="font-normal text-[18px] text-black font-poppins ">
                          {list}
                        </li>
                      );
                    })}
                    ...
                    <div className="flex  mx-auto mt-5">
                      <button
                        ...
                        className="w-[210px] h-[49px] mt-3  relative bg-black rounded-[37px] border 
          ...
          before:hover:scale-x-100  "
                    ...
                    {openForm && formId === job.id && (
                      <div className=" fixed z-40  top-0 left-0 right-0 bottom-0 bg-transparent  flex justify-center items-start py-5">
                        <div className="bg-white lg:w-[40%] md:w-[80%] relative w-[90%] h-fit py-8 rounded-[30px]  border border-[#B3B3B3]">
                          ...
                          <form
                            ...
                            className="w-full gap-y-5 flex flex-col justify-center items-center"
                          >
                            <p className="lg:text-[46px] text-[32px] text-black font-bold font-poppins mb-5">
                              Job Application
                            </p>
                            <div className="flex flex-col md:w-[80%] w-[90%] gap-y-2">
                              <label className="text-[20px] font-medium font-poppins text-black ">
                                Full Name
                              </label>
                              <input
                                ...
                                id="fullname"
                                type="text"
                                className="w-full h-[45px] border px-2 border-[#B3B3B3] rounded-[5px] 
                  ...
                  placeholder:text-[#B3B3B3] placeholder:text-[14px] placeholder:font-poppins placeholder:font-normal "
                            ...
                            {/* <div className='flex flex-col md:w-[80%] w-[90%] gap-y-2'>
                   <label className='text-[20px] font-medium font-poppins text-black '>Upload Your CV</label>
                   <input placeholder='Choose File' name='file' id='file' type='file' className=''/>
                            ...
                            <input
                              ...
                              value={job.jobTitle}
                            />
                            <button className="md:w-[80%] w-[90%] rounded-[8px] mt-2 text-[20px] font-medium bg-black h-[57px] text-white ">
                              Apply Now
                            </button>
                          </form>
                        </div>
