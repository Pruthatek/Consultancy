...
const GetInTouch = () => {
  ...
  return (
    <>
      <div className="relative z-40 font-poppins bg-black">
        <div className="w-full lg:h-[700px] md:h-[600px] h-[500px] relative ">
          <div className="absolute bg-gradient-to-b top-0 left-0 right-0 bottom-0 from-black to-transparent flex flex-col justify-start items-center">
            <div className="md:mt-40 mt-[100px]   flex flex-col items-center">
              <p className="font-semibold lg:text-[50px] md:text-[30px] text-[20px] text-[#B3B3B3] text-center px-4 md:px-10 lg:px-20 ">
                ...
                with a specific hiring need, our team is ready to provide the
                support you need.{" "}
              </p>
              <p className="md:text-[22px] text-[18px] font-medium font-poppins text-[#B3B3B3] text-center px-4 md:px-10 lg:px-20 md:mt-20 mt-14 ">
                {" "}
                Reach out to us through our contact form, email, or phone, and
                we'll respond promptly. Your success is our priority, and we're
                committed to making your recruitment process seamless and
                efficient.
              </p>
            </div>
          </div>
          <img
            ...
            className="w-full lg:h-[700px] md:h-[600px] h-[500px] lg:object-cover object-contain object-top "
          />
        </div>
      </div>

      <div className="mt-10">
        <p className="lg:text-[44px] md:text-[32px] text-[24px]  lg:px-[86px] md:px-10 px-5 text-black font-semibold font-poppins ">
          Contact Ontario Office{" "}
        </p>
        <div className="flex lg:flex-row flex-col  lg:justify-center gap-x-10 md:px-10 px-5  w-full  h-fit lg:items-start items-center ">
          <div className="lg:w-[60%] md:w-[90%] w-[100%]  h-fit mt-10">
            <form
              action=""
              onSubmit={onSubmit}
              className="w-full  flex flex-col gap-y-12 py-12 items-center bg-[#F5F5F5] rounded-[12px]  "
            >
              <input
                type="text"
                name="name"
                ...
                className="md:w-[70%] w-[85%] h-[40px] border-b  border-b-[#505050] bg-transparent placeholder:text-[#505050] placeholder:text-[20px] "
              />
              <input
                type="email"
                name="email"
              ...
              <div className="flex  mx-auto ">
                <button
                  type="submit"
                  className="w-[180px] h-[49px]   relative bg-black rounded-[37px] border 
          ...
          <div className="lg:w-[30%] md:w-[50%] w-[100%] h-fit mt-10  border-[2px] border-[#505050] rounded-[12px] px-10 py-8">
            <p className="text-[28px] font-semibold text-black font-poppins ">
              Contact Details
            </p>
            <address className="not-italic text-[24px] font-normal font-poppins mt-8 ">
              G-10 Arasmant flat, nr.<br></br>
