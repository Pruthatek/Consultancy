      ...
      <div className="w-full lg:h-full md:h-[600px] h-[500px] relative ">
        <div className="absolute bg-gradient-to-b top-0 left-0 right-0 bottom-0 from-black to-transparent flex flex-col justify-start items-center">
          <div className="md:mt-40 mt-[100px]   flex flex-col items-center">
            <p className="font-bold lg:text-[46px] md:text-[32px] text-[24px] text-white text-center px-4 md:px-0 ">
              Find The Right People For Your Team
            </p>
            <p className="font-medium lg:text-[24px] md:[18px] text-[14px] mt-4 text-white text-center px-4 md:px-0 ">
              Connecting Talent with Opportunity, Fuelling Innovation with Top
              Tech Minds.
            </p>
            <Link
              to={"/searchjobs"}
              onClick={() => setActive("Search Jobs")}
              className="md:w-[210px] md:h-[54px] w-[170px] h-[44px] relative bg-white rounded-full border 
