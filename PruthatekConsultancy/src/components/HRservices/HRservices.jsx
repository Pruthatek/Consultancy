        ...
        <div className="w-full lg:h-full md:h-[600px] h-[500px] bg-black  relative ">
          <div className="absolute bg-gradient-to-b top-0 left-0 right-0 bottom-0 from-black to-transparent flex flex-col justify-start items-center">
            <div className="lg:mt-40 mt-[100px]   flex flex-col items-center">
              <p className="font-[500] lg:text-[24px] md:text-[20px] text-[18px] text-[#B3B3B3]   text-center px-4 md:px-10 lg:px-20  lg:leading-10">
                We offer tailored HR solutions to streamline your workforce
                management, providing expert guidance in employee relations,
                compliance, and development. Our goal is to empower your HR team
            ...
            return (
              <div className=" group lg:w-[30%] md:w-[40%] w-[90%] h-[424px] relative ">
                <div className="absolute w-full h-full group-hover:bg-black/10 duration-500 transition-all rounded-[46px] bg-black/60 flex justify-center items-center ">
                  <button
                    onClick={() => changeContent(service)}
                    className="w-fit h-fit px-5  py-3 rounded-[18px] border-[2px] group-hover:bg-white group-hover:text-black duration-500 transition-all border-white font-[500] lg:text-[24px] text-[22px] font-poppins text-white "
                  >
                    {service.name}
                  </button>
                </div>
                  ...
                  <div className=" fixed z-40  top-0 left-0 right-0 bottom-0 bg-black bg-opacity-20 flex justify-center items-center">
                    <div className="lg:w-[80%] w-[90%]  h-fit py-10 md:rounded-[50px] rounded-[30px] relative  bg-white lg:px-10 md:px-6 px-4 gap-x-8 flex md:flex-row flex-col  items-center ">
                      <X
                        size={28}
                        color={"#AEAEB2"}
                        className="absolute md:right-8 right-4 top-8 cursor-pointer"
                        onClick={changeContent}
                      />
                      <img
                        src={pop.img}
                        className="md:w-[50%] w-[80%] md:h-[80%] h-[70%] rounded-[18px] "
                      />
                      <div className="">
                        <p className="font-[600] lg:text-[35px] md:text-[30px] text-[22px] text-black font-poppins mt-4 md:mt-0">
                          {pop.name}
                        </p>
                        <p className="font-[400] lg:text-[20px] md:text-[18px] text-[12px] text-[#101010] font-poppins md:mt-5 mt-3 md:leading-9 leading-6">
                          {pop.content}
                        </p>
                      </div>
                    </div>
